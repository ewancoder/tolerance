...
add:=0;
  ...
  if c=0 then temp:=floattostr(dsize/2)+' μκμ' else temp:=floattostr(dsize/2000)+' μμ';
  ...
  /////ppppp.Canvas.TextOut(320,40,minl+floattostr(size-dsize/2000)+' μμ,');
  /////ppppp.Canvas.TextOut(320,60,maxl+floattostr(size+dsize/2000)+' μμ,');
  end else begin
  if (b21<12)and(b22=-1) then begin
  mk1:=si-round(deviation*fs);
  mk2:=si-round(deviation*fs-dsize*fs);
  /////ppppp.Canvas.TextOut(320,60,maxl+floattostr(size+deviation/1000)+' μμ,');
  /////ppppp.Canvas.TextOut(320,40,minl+floattostr(size+deviation/1000-dsize/1000)+' μμ,');
  ...
  if c=0 then temp:=floattostr(deviation)+' μκμ' else temp:=floattostr(deviation/1000)+' μμ';
  ...
  if c=0 then temp:=floattostr(deviation-dsize)+' μκμ' else temp:=floattostr((deviation-dsize)/1000)+' μμ';
  ...
  /////  ppppp.Canvas.TextOut(320,40,minl+floattostr(size+deviation/1000)+' μμ,');
  /////ppppp.Canvas.TextOut(320,60,maxl+floattostr(size+deviation/1000+dsize/1000)+' μμ,');
  ...
  if c2=0 then temp:=floattostr(dsize2/2)+' μκμ' else temp:=floattostr(dsize2/2000)+' μμ';
  ...
  /////ppppp.Canvas.TextOut(320,120,minl+floattostr(size2-dsize2/2000)+' μμ,');
  /////ppppp.Canvas.TextOut(320,140,maxl+floattostr(size2+dsize2/2000)+' μμ');
  end else begin
  if (b31<>-1) then begin
    if deviation2<0 then begin
    mk3:=si-round(deviation2*fs+dsize2*fs);
    mk4:=si-round(deviation2*fs);
   ///// ppppp.Canvas.TextOut(320,120,minl+floattostr(size2+deviation2/1000)+' μμ,');
   ///// ppppp.Canvas.TextOut(320,140,maxl+floattostr(size2+deviation2/1000+dsize2/1000)+' μμ,');
    ...
    if c2=0 then temp:=floattostr(deviation2+dsize2)+' μκμ' else temp:=floattostr((deviation2+dsize2)/1000)+' μμ';
    ...
    if c2=0 then temp:=floattostr(deviation2)+' μκμ' else temp:=floattostr(deviation2/1000)+' μμ';
 ...
 ///// ppppp.Canvas.TextOut(320,140,maxl+floattostr(size2+deviation2/1000)+' μμ,');
 ///// ppppp.Canvas.TextOut(320,120,minl+floattostr(size2+deviation2/1000-dsize2/1000)+' μμ,');
